...
//
// Parts connect by MOUNT SLOT MATCHING (slots.js): joints define their two
// mount slots (jointMounts), parts re-export them in part space
// (kit.partSlots), and a rig definition just names which slot mates with
// which — a joint's bones rotate about the match point.
import { meshOf } from "./primitives.js";
import { I3, vAdd, vLen, vNorm, vCross, m3Mul, m3MulV, m3Rot } from "./math.js";
