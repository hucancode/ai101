...
// the part catalog: a builder per part, its default params, and the slots it
// publishes. A rig supplies the add() sink and applies its own placement —
// parts stay the single source of geometry, the rig never re-models anything.
