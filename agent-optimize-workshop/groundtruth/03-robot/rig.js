...
import { buildPart, partSlots } from "./parts.js";
import { colorMemo } from "./color.js";
import { bake } from "./primitives.js";
import { createSkeleton, addBall, createMeshCache, xfCompose, xfT } from "./skeleton.js";
import { matchRot } from "./slots.js";
import { rad, vAdd, vSub, vScale, m3Mul, m3MulV } from "./math.js";
...
export function createAtlasRig(seed = 1) {
  const defs = ATLAS_DEF.map((d) => ({ ...d, slots: partSlots(d.part, d.params ?? null) }));
  ...
  const capture = (d, ppose, out) => {
    buildPart(d.part, (g) => {
      const b = bake(g);
      out.push({
        key: b.key, mesh: b.mesh, m: b.m, t: b.t,
        color: colorFor(b.id),
      });
    }, d.params ?? null, ppose);
    return out;
